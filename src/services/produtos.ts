...
export interface NormalizeCollisionItem {
  id: string
  original: string
  descricao: string
}
...
export const normalizeProdutoCodes = async (): Promise<NormalizeReport> => {
  return pb.send('/backend/v1/produtos/normalize-codes', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
  })
}
